...
describe 'Data' do
    ...
    describe "export_tables" do
        describe "should export data properly" do
            it "when directory /csv doesn't exist" do
                ...
                assert_equal count_records,count_saved_records
            end
    ...
    describe "import_tables" do
        describe "should import data properly" do
    ...
    describe "import_data" do
        describe "should raise ArgumentError" do
          it "when all .csv files don't exist" do
            proc{DataController.import_tables}.must_raise ArgumentError
          end
